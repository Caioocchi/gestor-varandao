...
// Load environment variables from .env.local if it exists (for local overrides)
  ...
  return {
    ...
    build: {
      ...
      env: {
        ...
        FIREBASE_VAPID_KEY: process.env.FIREBASE_VAPID_KEY || process.env.VITE_FIREBASE_VAPID_KEY || '',
      },
      // rawDefine: {}
    ...
    pwa: {
      ...
      manifest: {
        ...
        short_name: 'Varandão',
        description: 'Gestão de freelancers',
        display: 'standalone',
